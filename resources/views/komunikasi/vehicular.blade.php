...
@section('contentheader')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"> VEHICULAR {{ $unit }} </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">ASET VEHICULAR</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">ASET VEHICULAR BOLEH GUNA {{ $unit }}</h3>
        ...
        <div class="col-md-6">
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">ASET VEHICULAR TIDAK BOLEH GUNA {{ $unit }}</h3>
        ...
        function createChart() {
            $("#chart").kendoChart({
                ...
                seriesClick: function(e) {
                    ...
                    // console.log( "decode :" +  decode + 'endcode : '+ encoded);
    ...
    <script>
        function unit(selectObject) {
            ...
            location.href = '{{ url('/reports/view/vehicular/') }}' + '/' + pasukan_id;
