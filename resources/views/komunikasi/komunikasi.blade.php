...
@section('contentheader')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="text-transform: uppercase;">KOMUNIKASI {{ $unit }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                <div class="small-box bg-info">
                    <div class="inner">
                        {{-- <img src="{{url('images/walkie-talkie.png')}}" class="float-right" height="50%" width="25%"> --}}
                        <h3>{{ number_format($count_manpack) }}</h3>
                        <p>RADIO MAN PACK</p>
                    </div>
                    <a href="{{ route('manpack', ['id' => $caripasukan->id]) }}" class="small-box-footer">More info <i
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    <div class="inner">
                        {{-- <img src="{{url('images/radio-transmitter.png')}}" class="float-right" height="50%" width="25%"> --}}
                        <h3>{{ number_format($count_vehicular) }}</h3>
                        <p>ASET VEHICULAR</p>
                    </div>
                    <a href="{{ route('vehicular', ['id' => $caripasukan->id]) }}" class="small-box-footer">More info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                    <div class="inner">
                        {{-- <img src="{{url('images/radio-transmitter.png')}}" class="float-right" height="50%" width="25%"> --}}
                        <h3>{{ number_format($count_Armd_Comfit) }}</h3>
                        <p>ASET ARMD COMFIT</p>
                    </div>
                    <a href="{{ route('ArmdComfit', ['id' => $caripasukan->id]) }}" class="small-box-footer">More info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="card  card-warning">
                <div class="card-header">
                    <h3 class="card-title">KEUPAYAAN DAN KESIAGAAN KESELURUHAN {{ $unit }}</h3>
                </div>
                <div class="card-body">
                    @if ($bolehgunatiadadata == 0)
        ...
        function createChart() {
            $("#chart").kendoChart({
                ...
                seriesClick: function(e) {
                    location.href = '{{ url('/reports/view/komunikasiBG/') }}' + '/' + e.category + '/' + pasukan_id + '/' + 'KOMUNIKASI';
                }
            });
        }
        ...
        function createChart() {
            $("#charttidakbolehguna").kendoChart({
                ...
                seriesClick: function(e) {
                    ...
                    location.href = '{{ url('/reports/view/komunikasiTBG/') }}' + '/' + e.category + '/' + pasukan_id + '/' + 'KOMUNIKASI';
                }
            });
        }
    ...
    <script>
        function unit(selectObject) {
            ...
            location.href = '{{ url('/reports/view/komunikasi/') }}' + '/' + pasukan_id;
        }
    </script>
@endsection
