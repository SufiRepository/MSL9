...
@section('contentheader')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="text-transform: uppercase;">PERTAHANAN UDARA {{ $unit }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">PERTAHANAN UDARA</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">ASET BOLEH GUNA {{ $unit }}</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                            <i class="fas fa-minus"></i>
                        </button>
        ...
        <div class="col-md-6">
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">ASET TIDAK BOLEH GUNA {{ $unit }}</h3>
        ...
        function createChart() {
            $("#chart").kendoChart({
                ...
                seriesClick: function(e) {
                    location.href = '{{ url('/reports/view/bolehgunasub/') }}' + '/' + e.category + '/' + pasukan_id+ '/' + 'PERTAHANAN UDARA' ;
                }
            });
        }
    ...
    <script>
        ...
        function createChart() {
            $("#charttidakbolehguna").kendoChart({
                ...
                seriesClick: function(e) {
                    location.href = '{{ url('/reports/view/tidakbolehgunasub/') }}' + '/' + e.category + '/' + pasukan_id + '/' + 'PERTAHANAN UDARA' ;
                }
            });
        }
    ...
    <script>
        function unit(selectObject) {
            ...
            location.href = '{{ url('/reports/view/pasukankhas/') }}' + '/' + pasukan_id;
