...
@section('contentheader')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="text-transform: uppercase;">ASSET KJA {{ $unit }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">ASET KJA</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title" style="text-transform: uppercase;"> ASET BOLEH GUNA {{ $unit }}</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title" style="text-transform: uppercase;">ASET TIDAK BOLEH GUNA {{ $unit }}
                    </h3>
                </div>
                <div class="card-body">
        ...
        function createChart() {
            $("#chart").kendoChart({
                ...
                seriesClick: function(e) {
                    location.href = '{{ url('/reports/view/bolehgunasub/') }}' + '/' + e.category + '/' +pasukan_id+ '/' +'ASET KJA';
        ...
        function createChart() {
            $("#charttidakbolehguna").kendoChart({
                ...
                seriesClick: function(e) {
                    ...
                    location.href = '{{ url('/reports/view/tidakbolehgunasub/') }}' + '/' + e.category + '/' +pasukan_id+ '/' +'ASET KJA';
                }
            });
        }
    ...
    <script>
        function unit(selectObject) {
            ...
            location.href = '{{ url('/reports/view/kja/') }}' + '/' + pasukan_id;
