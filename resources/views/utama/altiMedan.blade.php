...
@section('contentheader')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="text-transform: uppercase;">ASET MEDAN {{ $unit }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> ASET MEDAN</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        function createChart() {
            $("#chart").kendoChart({
                ...
                seriesClick: function(e) {
                    ...
                    location.href = '{{ url('/reports/view/bolehgunasub/') }}' + '/' + e.category + '/' + pasukan_id + '/' + 'MEDAN' ;
    ...
    <script>
        ...
        function createChart() {
            $("#charttidakbolehguna").kendoChart({
                ...
                seriesClick: function(e) {
                    location.href = '{{ url('/reports/view/tidakbolehgunasub/') }}' + '/' + e.category + '/' + pasukan_id + '/' + 'MEDAN' ;
                }
            });
        }
